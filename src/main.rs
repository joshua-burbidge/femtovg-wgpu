...
//             helpers::start_opengl(event_loop, width, height, title, resizeable);
...
//     // surface: Option<dyn WindowSurface<Renderer = OpenGl>>,
//     surface: Option<W>,
// }
...
//         let (canvas, surface, window) =
//             helpers::start_opengl::<W>(event_loop, 1000, 600, "my demo", true);
